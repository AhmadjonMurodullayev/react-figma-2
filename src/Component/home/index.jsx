...
function Hero() {
  return (
    <div className="m-auto  flex flex-col-reverse p-3 md:px-5 max-w-[1440px] mx-auto md:flex-row text-black font-semibold w-[90%]">
...
function Posts() {
  return (
    <div className="px-3 mx-auto md:px-5 max-w-[1440px] py-3 flex flex-col gap-4 bg-[#EDF7FA] m-auto w-[90%] ">
...
function Works() {
  return (
    <div className="px-3 mx-auto md:px-5 max-w-[1440px] py-3 flex flex-col gap-4 m-auto w-[90%]">
